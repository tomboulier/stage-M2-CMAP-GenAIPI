...
Imaging in Traumatic Brain Injury), mené au CHU de Grenoble, dont l'objectif est de développer des
modèles de génération d'images permettant de prédire l'évolution des lésions hémorragiques au scanner
chez des patients ayant subi un traumatisme crânien. Cette pathologie est la première cause de handicap 
...
dans le projet GenAIPI-TBI est la \textbf{rareté des données} : le projet dispose d'environ
