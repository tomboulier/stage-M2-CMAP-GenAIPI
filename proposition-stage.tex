...
al.~\cite{brossard2023til} pour prédire l'intensité thérapeutique en réanimation.
...
L'étude portera sur le \textbf{fine-tuning} de ce modèle sur le dataset
\textbf{CQ-500}~\cite{chilamkurthy2018cq500} (491 scanners cérébraux, dont 205 avec
hémorragies intracrâniennes), afin de mesurer la qualité de génération en fonction
du nombre d'exemples d'entraînement.
